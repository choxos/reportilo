...
* Machine-readable **checklists** for the major families (CONSORT, STROBE,
  PRISMA, SPIRIT, STARD and more), with provenance and parse-confidence for
  every item.
* Data-driven **flow diagram** templates: PRISMA 2020, CONSORT and STARD.
...
entries that link to their original source. See `parse_status` for per-guideline
coverage.
