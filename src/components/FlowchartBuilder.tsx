    ...
    <div className="grid md:grid-cols-[360px_1fr] gap-6">
      <aside className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          ...
          <button
            className="rounded bg-teal text-white px-3 py-2 text-sm font-medium hover:bg-teal/90 disabled:opacity-50"
            disabled={!svg}
            onClick={() => downloadSvg(svg, `${templateId}.svg`)}
          >
            SVG
          </button>
          <button
          ...
          <button
            ...
            onClick={() => flowchartXlsx(countsRows(), `${templateId}.xlsx`)}
          >
            Excel
          </button>
          <button
            ...
            onClick={() =>
              saveText(toCsv(countsRows()), `${templateId}.csv`, "text/csv;charset=utf-8")
            }
          >
            CSV (counts)
          </button>
