...
prisma_2020 <- rbind(
  ...
  prisma("Methods", "6", "Specify all databases, registers, websites, organisations, reference lists and other sources searched or consulted; specify the date when each was last searched or consulted."),
  ...
  prisma("Results", "20a", "For each synthesis, briefly summarise the characteristics and risk of bias among contributing studies."),
...
consort_2010 <- rbind(
  consort("Title and abstract", "1a", "Identification as a randomised trial in the title."),
  ...
  consort("Methods", "8b", "Type of randomisation; details of any restriction (such as blocking and block size)."),
  ...
  consort("Results", "13a", "For each group, the numbers of participants who were randomly assigned, received intended treatment, and were analysed for the primary outcome."),
  consort("Results", "13b", "For each group, losses and exclusions after randomisation, together with reasons."),
...
strobe_v <- rbind(
  ...
  strobe("Results", "14", "Give characteristics of study participants and information on exposures and potential confounders; indicate number of participants with missing data for each variable of interest; (cohort) summarise follow-up time."),
  ...
  strobe("Discussion", "18", "Summarise key results with reference to study objectives."),
